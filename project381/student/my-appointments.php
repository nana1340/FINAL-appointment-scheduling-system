                                    ...
                                    <?php foreach ($appointments as $appointment) { ?>
                                        ...
                                        if (
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="btn btn-danger btn-small" href="?cancel=<?php echo htmlspecialchars((string) $appointment['id']); ?>&csrf_token=<?php echo htmlspecialchars(generateCsrfToken()); ?>">Cancel</a></td>
                                            </tr>
                                        <?php } ?>
                                    <?php } ?>
                                    <?php if (!$hasUpcoming): ?>
                        ...
                        <div class="table-wrapper">
                            <table>
                                ...
                                <tbody>
                                    ...
                                    href="?cancel=<?php echo htmlspecialchars((string) $appointment['id']); ?>&csrf_token=<?php echo htmlspecialchars(generateCsrfToken()); ?>"
