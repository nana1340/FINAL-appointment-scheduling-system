                    ...
                    <?php if (count($notifications) > 0) { ?>
                        <?php foreach ($notifications as $notification) { ?>
                            <div class="notification-item">
                                ...
                                <a class="btn btn-small" href="?read_notification=<?php echo htmlspecialchars((string) $notification['id']); ?>&csrf_token=<?php echo htmlspecialchars(generateCsrfToken()); ?>">Mark as read</a>
                            </div>
                        <?php } ?>
                    <?php } else { ?>
